...
class ForumClient(Client):
    ...
    def invite_to_question_get(self, question_pk):
        return self.get(reverse("forum:invite", args=[question_pk]), follow=True)
    ...
    def delete_article(self, article_pk: int):
        return self.post(reverse("articles:delete", args=[article_pk]), follow=True)

    def delete_article_get(self, article_pk: int):
        return self.get(reverse("articles:delete", args=[article_pk]), follow=True)

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('editor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('users_downvoted', models.ManyToManyField(blank=True, related_name='_forum_question_users_downvoted_+',
                                                           to=settings.AUTH_USER_MODEL)),
                ('users_upvoted', models.ManyToManyField(blank=True, related_name='_forum_question_users_upvoted_+',
                                                         to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('flags',
                 models.ManyToManyField(blank=True, related_name='_forum_questioncomment_flags_+', to='forum.flag')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments',
                                               to='forum.question')),
                ('users_upvoted',
                 models.ManyToManyField(blank=True, related_name='_forum_questioncomment_users_upvoted_+',
                                        to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('flags',
                 models.ManyToManyField(blank=True, related_name='_forum_answercomment_flags_+', to='forum.flag')),
                ('users_upvoted',
                 models.ManyToManyField(blank=True, related_name='_forum_answercomment_users_upvoted_+',
                                        to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='_forum_answer_users_downvoted_+',
                                         to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='answer',
            name='users_upvoted',
            field=models.ManyToManyField(blank=True, related_name='_forum_answer_users_upvoted_+',
                                         to=settings.AUTH_USER_MODEL),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bookmarks',
                                               to='forum.question')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bookmarks',
                                           to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('invitee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+',
                                              to=settings.AUTH_USER_MODEL)),
                ('inviter', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                              related_name='+', to=settings.AUTH_USER_MODEL)),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invitations',
                                               to='forum.question')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.IntegerField(default=0, help_text='Reputation earned by user for tag in the past month'),
        ),
        migrations.AddField(
            model_name='tagfollow',
            name='updated_at',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('reputation_change',
                 models.IntegerField(blank=True, default=None, help_text='Change in reputation for target user',
                                     null=True)),
                ('answer', models.ForeignKey(blank=True, default=None, help_text='Answer that caused this, if relevant',
                                             null=True, on_delete=django.db.models.deletion.CASCADE,
                                             to='forum.answer')),
                ('question', models.ForeignKey(blank=True, default=None, help_text='Question caused this', null=True,
                                               on_delete=django.db.models.deletion.CASCADE, to='forum.question')),
                ('source', models.ForeignKey(blank=True, help_text='User who voted to create this activity', null=True,
                                             on_delete=django.db.models.deletion.DO_NOTHING, related_name='+',
                                             to=settings.AUTH_USER_MODEL)),
                ('target', models.ForeignKey(help_text='User affected by this activity',
                                             on_delete=django.db.models.deletion.CASCADE,
                                             related_name='reputation_votes', to=settings.AUTH_USER_MODEL)),
                ('seen',
                 models.DateTimeField(blank=True, default=None, help_text='When the target user has seen this activity',
                                      null=True)),
                ('badge', models.ForeignKey(blank=True, default=None, help_text='Badge on this activity', null=True,
            ...
            fields=[
                ('question',
                 models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False,
                                      to='forum.question')),
                ('source', models.CharField(choices=[('slack', 'Slack'), ('teams', 'Microsoft Teams')], max_length=10)),
        ...
        migrations.AddIndex(
            model_name='questionadditionaldata',
            index=django.contrib.postgres.indexes.GinIndex(fields=['search_vector'],
                                                           name='forum_quest_search__208074_gin'),
        ),
        migrations.RunPython(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(help_text='User affected by this activity',
        ...
        migrations.AddField(
            model_name='question',
            name='status',
            field=models.CharField(choices=[('a', 'Open'), ('t', 'Triaged'), ('c', 'Closed'), ('d', 'Duplicate')],
                                   default='a', help_text='Question status', max_length=2),
        ),
        migrations.DeleteModel(
            name='IntegrationQuestion',
        ),

...
class TestUsersAutocompleteView(ForumApiTestCase):
    ...
    def test_users_autocomplete__when_given_username__should_return_all_users_besides_logged_in(self):
    ...
    def test_users_autocomplete__when_given_name_and_selected__should_return_1_users(self):
        self.client.login(self.usernames[2], self.password)
        query = self.usernames[2][:-1]

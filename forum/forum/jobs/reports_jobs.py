...
from forum.reports import recent_questions_email_report, generate_report_html, tags_activity_email_report, \
    user_activity_email_report, old_unanswered_questions_email_report, tags_author_should_report
from forum.views import utils as viewutils
from userauth.models import ForumUser
from userauth.utils import unsubscribe_link_with_base


def weekly_digest_to_user(user: ForumUser,
    ...
    html = generate_report_html(
        ...
        [tags_empty_desc, digest_report, unanswered_questions, ],

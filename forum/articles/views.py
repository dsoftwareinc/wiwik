...
from forum.views.helpers import _get_request_query, _get_request_tab, _get_questions_queryset
...
def view_article_edit(request, pk: int):
    ...
    if not editviews.ask_to_edit_resource(request.user, article):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            editviews.finish_edit_resource(article)

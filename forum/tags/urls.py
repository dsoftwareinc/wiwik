...
urlpatterns = [
    ...
    path('tags-autocomplete/', views.view_tags_autocomplete, name='autocomplete', ),

    path('synonyms/', views.view_synonym_list, name='synonyms_list'),
    path('synonyms/approve/<int:synonym_pk>', views.view_approve_synonym, name='synonyms_approve'),
]

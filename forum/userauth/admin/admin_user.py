...
class VotesActivityAdmin(admin.TabularInline):
    ...
    model = VoteActivity
    fk_name = 'source'
    fields = ('reputation_change', 'target', 'created_at', 'question', 'answer',)
    readonly_fields = ('reputation_change', 'created_at', 'question', 'answer',)
...
class ForumUserAdmin(UserAdmin):
    ...
    save_on_top = True
    inlines = (VotesActivityAdmin, BadgesAdmin,)

...
class PostSimilarityAdmin(NumericFilterModelAdmin):
    list_display = ('id', 'q1_id', 'q2_id', 'rank', 'tfidf_rank', 'postgres_rank',
                    'postgres_trigram_rank', 'created_at', 'updated_at',)
    readonly_fields = ('question1', 'question2', 'rank', 'tfidf_rank', 'postgres_rank',
                       'postgres_trigram_rank', 'created_at', 'updated_at',)

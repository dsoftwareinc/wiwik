...
moderation_badges = [
    BadgeData(
        "Editor",
        "First edit",
        partial(user_edited_count_vs_expected, 1),
        BadgeType.BRONZE,
        True,
        TRIGGER_EVENT_TYPES["Update post"],
        group=1,
        required=1,
    ),
    BadgeData(
        "Strunk & White",
        "Edit 20 posts",
        partial(user_edited_count_vs_expected, 20),
        BadgeType.BRONZE,
        True,
        TRIGGER_EVENT_TYPES["Update post"],
        group=1,
    ...
    BadgeData(
        "Copy editor",
        "Edit 100 posts",
        partial(user_edited_count_vs_expected, 100),
        BadgeType.GOLD,
        False,
        TRIGGER_EVENT_TYPES["Update post"],
        group=1,
    ...
    BadgeData(
        "Supporter",
        "First upvote",
        partial(user_upvoted_count_vs_expected, 1),
        BadgeType.BRONZE,
        True,
    ...
    BadgeData(
        ...
        partial(user_upvoted_competing_answers_count_vs_expected, 10),
        BadgeType.SILVER,
        True,
        TRIGGER_EVENT_TYPES["Upvote"],
        group=3,
